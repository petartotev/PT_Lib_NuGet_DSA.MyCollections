namespace PetarTotev.Net.DSA.MyCollections.Tests
{
    ...
    class MyTreeBinarySearch2Tests
    {
        private MyTreeBinarySearch2<int> _bst;

        [SetUp]
        public void InitializeBST()
        {
            this._bst = new MyTreeBinarySearch2<int>();
            this._bst.Insert(12);
            this._bst.Insert(21);
            this._bst.Insert(5);
            this._bst.Insert(1);
        ...
        public void TestDeleteMinWorksCorrectlyWithTwoDeletions()
        {
            ...
            Assert.AreEqual(8, this._bst.Root.Left.Value);
        }

        [Test]
        public void TestDeleteMinThrowsExceptionOnEmptyCollection()
        {
            var myBst = new MyTreeBinarySearch2<int>();
        ...
        public void TestDeleteMaxWorksCorrectlyWithTwoDeletions()
        {
            ...
            Assert.AreEqual(18, this._bst.Root.Right.Value);
        }
